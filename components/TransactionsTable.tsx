      ...
      <Table className="w-full table-fixed">
        <TableHeader className="bg-[#f9fafb]">
          <TableRow>
            ...
            <TableHead className="px-2 w-[12.5%] max-md:hidden">Channel</TableHead>
            <TableHead className="px-2 w-[12.5%] max-md:hidden">Category</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
          {transactions.map((t: Transaction) => {
            ...
            return (
              <TableRow key={t.id} className={`${isDebit || amount[0] === '-' ? 'bg-[#FFFBFA]' : 'bg-[#F6FEF9]'} !border-b-DEFAULT`}>
                ...
                <TableCell className="px-2 capitalize max-md:hidden">
                  {t.paymentChannel}
                </TableCell>
